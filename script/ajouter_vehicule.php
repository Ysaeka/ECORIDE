...
$insertionVoiture = $bdd->prepare("INSERT INTO voiture (modele, immatriculation, couleur, date_premiere_immatriculation, marque_id, energie, users_id) VALUES (?, ?, ?, ?, ?, ?, ?)");
$insertionVoiture->execute([$modele, $numPlaque, $couleur, $datePlaque, $marque_id, $energie, $userId]);

header("Location: ../index.php?page=profil&users_id="); 
exit;
