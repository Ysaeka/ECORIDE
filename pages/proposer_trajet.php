<?php
    ...
    require_once __DIR__ . '/../templates/villes.php';
    ...
    <main>
        <?php if (!$islog) : ?>
            ...
            <section class = "visiteur">
                ...
                <div class ="linkVisiteur">
                        <a class="visiteurConn" href = "index.php?page=connexion"> Connectez-vous ici ! </a>
                        <br>
                        <a href = "index.php?page=inscription"> Vous n'avez pas de compte ? </a>
                </div>
            </section>
        ...
        <?php else : ?>
            ...
            <div class="proposerTrajet">
                ...
                <form method ="POST" action="index.php?page=enregistrer_trajet" id="formTrajet" novalidate>
