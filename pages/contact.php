<body>
    ...
    require_once __DIR__ . '/../script/envoi_mail_contact.php';
    ?>
    ...
    <main>
        ...
        <div id="nousContacter"><h2> NOUS CONTACTER <i class="fa-solid fa-envelopes-bulk fa-lg" style="color: #148b41;"></i></h2></div>
            <form method ="POST" action="index.php?page=contact" id= formContact novalidate>
        ...
        <?php
            ...
            if (isset($btnEnvoyer) && $btnEnvoyer === "soumettre"){
                    ...
                    $content = "
                        ...
                        ";
                    EnvoieMailContact($mail, $envoiMail, $content, $subject);
            }
            }
        ?>
    </main>
