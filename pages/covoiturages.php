        ...
        <section class = "containerResult">
                ...
                <div class = "trajetResult">
                    <?php if(!empty($results)): ?>
                        <div class = trajet>
                            <h3 class="depart"> <i class="fa-solid fa-calendar-days fa-lg" style="color: #148b4b;"></i><?= htmlspecialchars(date('d/m/Y', strtotime($date))) ?> --- <i class="fa-solid fa-flag-checkered fa-lg" style="color: #148b4b;"></i><?= ucfirst(htmlspecialchars($ville_depart))?> -> <?= ucfirst(htmlspecialchars($ville_arrivee))?></h3>
                            <h3 class="nbTrajet"> <?= count($results)?> trajets disponibles </h3>
                        </div>
                        ...
                        <?php foreach ($results as $trajet):
                            ...
                            <div class="linkResult">
                                <a href = "index.php?page=reservation&id=<?= $trajet['covoiturage_id'] ?>">
                                    <span class = "detailsTrajet">
                                        <span class ="horaires"><i class="fa-solid fa-clock fa-lg" style="color: #148b4b;"></i><?= $h_depart ?> o--- <?= $duree ?> ---o <?= $h_arrivee ?> </span>
